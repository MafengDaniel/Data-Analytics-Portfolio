...
## Overview
This Power BI project analyzes global workforce compensation, employment patterns, and organizational metrics using a star schema data model.
...
**For detailed documentation, see the project files in this directory.**
